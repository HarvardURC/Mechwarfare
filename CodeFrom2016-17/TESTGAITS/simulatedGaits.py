...
HOME_LEG_POSITIONS = [[45.0, 0.0, 0.0],[-45.0, 0.0, 0.0],[-47.0, 0.0, 0.0],[45.0, 0.0, 0.0]]
...
def getCurrentAngles(legNum):
    ...
    idealHipAngle = servoHipAngle + IDEAL_SERVO_POSITIONS[legNum - 1][0] - HOME_LEG_POSITIONS[legNum - 1][0]
    idealKneeAngle = servoKneeAngle + IDEAL_SERVO_POSITIONS[legNum - 1][1] - HOME_LEG_POSITIONS[legNum - 1][1]
    idealAnkleAngle = servoAnkleAngle + IDEAL_SERVO_POSITIONS[legNum - 1][2] - HOME_LEG_POSITIONS[legNum - 1][2]
...
print("displacement: ", getDisplacementFromAngles(3,getCurrentAngles(3)))
'''

#moveServos(3, 240, 0, -45)

#time.sleep(3)

#moveServos(3, 225, -40, 0)


#moveFoot(3,[2.5,-3,-2])
moveAndDragMultFeet([3], [[4.0, 0.0, -2]], [0])
